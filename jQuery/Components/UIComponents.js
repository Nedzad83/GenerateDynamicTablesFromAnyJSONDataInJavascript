(function () {
    ...
    ns.List = (function () {
        ...
        List.prototype.Render = function () {
            var _root = this;
            var elem = this.Response[Object.keys(this.Response)[0]];
            this.Response =  elem; // get first element
            this.Data = elem;
            ...
            if (this.Data && this.Response.length > 0) {
                ...
                $.each(this.Data, function (idx, element) {
                    ...
                    //  if (_root.Response.Fields.indexOf('image') > -1) {
                    //      var $tdImg = $("<td><a><img src=" + element.image + "></img></a></td>");
                    //      $tr.append($tdImg);
                    //  }
                    ...
                    for (var prop in element) {
                        ...
                        {
                            var $tdImg = $("<td><a><img style='height:100px' src=" + element.image + "></img></a></td>").css({ 'text-align': 'center' });;
                            $tr.append($tdImg);
                        }
                        else
                        {
